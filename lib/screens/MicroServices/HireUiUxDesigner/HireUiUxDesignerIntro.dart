...
import 'HireUiUxDesigner.dart';

class HireUiUxDesignerIntro extends StatelessWidget {
  const HireUiUxDesignerIntro({Key? key}) : super(key: key);
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => HireUiUxDesigner(),
                      ),
                    );
                  },
                  color: purpleAccent,
